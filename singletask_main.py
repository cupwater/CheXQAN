...
import models
from dataset.singletask_dataset import SingleTaskDataset
...
def main():
    ...
    trainset = SingleTaskDataset(train_list, train_meta, transform_train, prefix=args.prefix)
    ...
    testset = SingleTaskDataset(test_list, test_meta, transform_test, prefix=args.prefix)
